...
class JFormFieldcongreso extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		$query->select('id,title,category,description,link');
		...
		if ($messages)
		{
			...
			{
				$options[] = JHtml::_('select.option', $message->id, $message->title, $message->category, $message->description, $message->link);
			}
		}
